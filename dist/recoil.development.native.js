...
const {DEFAULT_VALUE: DEFAULT_VALUE$1} = Recoil_Node;
...
class MutableSnapshot extends Snapshot {
  constructor(treeState) {
    ...
    _defineProperty(this, 'set', (recoilState, newValueOrUpdater) => {
      ...
      const newValue = valueFromValueOrUpdater$1(
        store,
        recoilState,
        newValueOrUpdater,
      );
...
var require$$6 = getCjsExportFromNamespace(Recoil_Snapshot$1);
...
const {freshSnapshot: freshSnapshot$1} = require$$6;
...
const {Snapshot: Snapshot$1, cloneSnapshot: cloneSnapshot$1} = require$$6;
  ...
  return useMemo(() => {
    function useSetRecoilState(recoilState) {
      ...
      return newValueOrUpdater => {
        const newValue = valueFromValueOrUpdater$2(
          storeRef.current,
          recoilState,
          newValueOrUpdater,
        );
  ...
  return useCallback(
    (...args) => {
      ...
      !!(ret instanceof Sentinel)
        ? Recoil_invariant(false, 'batchedUpdates should return immediately')
        : void 0;
      return ret;
    },
...
var ParameterizedAtomTaggedValue_DEPRECATED = getCjsExportFromNamespace(
  Recoil_ParameterizedAtomTaggedValue_DEPRECATED,
);
