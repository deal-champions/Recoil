...
const {unstable_batchedUpdates: unstable_batchedUpdates} = reactNative;
...
var Recoil_RecoilValueInterface = {
  ...
  AbstractRecoilValue: AbstractRecoilValue$1,
  RecoilState: RecoilState$1,
  valueFromValueOrUpdater: function (store, {key: key}, valueOrUpdater) {
    ...
    super(cloneTreeState(treeState)),
      _defineProperty(this, 'set', (recoilState, newValueOrUpdater) => {
        const store = this.getStore_INTERNAL(),
          newValue = valueFromValueOrUpdater$1(
            store,
            recoilState,
            newValueOrUpdater,
          );
...
var Recoil_nullthrows = function (x, message) {
  ...
  require$$6 = getCjsExportFromNamespace(
    Object.freeze({
      __proto__: null,
...
const {
  ...
  {freshSnapshot: freshSnapshot$1} = require$$6,
  {
...
const {
  ...
  {Snapshot: Snapshot$1, cloneSnapshot: cloneSnapshot$1} = require$$6,
...
function useTreeStateClone_DEPRECATED() {
  ...
  return {
    transactionMetadata: {
      ...(state = storeRef.current.getState().currentTree).transactionMetadata,
    },
